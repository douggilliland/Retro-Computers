...
; Fix from https://raw.githubusercontent.com/Klaus2m5/6502_EhBASIC_V2.22/refs/heads/master/bugsnquirks.txt
;Ibuffs		= IRQ_vec+$14
Ibuffs            = VEC_SV+$16
...
LAB_2445:
	LDA	(Itempl),Y		; get byte via tempo:rary integer (addr)
