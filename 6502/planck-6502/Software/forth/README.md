...
## Compiling for the Planck computer
first install the [ophis assembler](https://michaelcmartin.github.io/Ophis/) and make.
Then just run `make taliforth-planck.bin` from the `forth` folder. This will create a 
`taliforth-planck.bin` in the `forth`folder.
Then you just need to program this to your ROM and plop it your computer.
