...
* with HiROM cartridge configuration (64KB banks mapped to $0000)
*
...
****************************************************************************/
                    ...
                    .setting "SNESHiROM", true         //HiROM configuration (64KB banks mapped to $0000)
                    ...
                    //Reconfigure the default Bank 0 to be 64KB, mapped at $0000
                    .bank 0, 64, $0000
                    ...
                    //****************************************************************************************
                    // Story time... This ROM configuration is in HiROM mode, meaning we work with 64KB banks.
                    // But the SNES is a special kind of hardware. By default it starts up in bank $00, where:
                    //
                    // $0000-$7fff is taken by the internal RAM and hardware registers.
                    // $8000-$ffff is used by a ROM bank, where the SNES maps in our Bank 0's UPPER 32KB.
                    //
                    // This means that no matter what we put into the lower 32KB of our 64KB Bank 0, it won't
                    // be visible by default. Later on, from code, if we select the SNES memory banks $40-$7d,
                    // our Bank 0 will be visible in the memory bank $40 in its full 64KB glory.
                    //
                    ...
                    //(It's because of the SNES hardware where only the upper 32KB of this bank is visible by default.)
                    .org $8000
