...
****************************************************************************/
                    ...
                    .format "gg"                        //Sega Game Gear
                    .setting "SMSCountryCode", 6        //USA (Export)
...
@ClearVRAM          out (VDPDataPort),a //Output to VRAM, into the current VRAM memory address.
                    ...
                    ld b,6              //The number of Palette_Data bytes.
...
Palette_Data        .byte $80, $0f      //G-R-z-B values for Blue
                    .byte $ff, $0f      //G-R-z-B values for White
                    .byte $00, $00      //G-R-z-B values for Black
