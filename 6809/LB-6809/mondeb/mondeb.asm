...
COPY1  LDA    ,X       ;GET BYTE FROM SOURCE
       ...
       STX    NBRHI    ;SAVE IT
       LDX    RANGLO   ;GET SOURCE ADDRESS POINTER
       CMPX    RANGHI   ;COMPARE TO END OF INPUT RANGE
...
DISPL8 CMPX    RANGHI   ;ARE WE DONE?
...
SEARC4 JSR    GETCHR
       ...
       CMPX    RANGHI   ;HAVE WE REACHED THE RANGE SEARCH UPPER LIMIT?
...
;GET NEXT LOWER POWER OF 10
       LEAX   2,X
       CMPX    #C10K+10 ;ARE WE THRU WITH UNITS CONVERSION?
...
NXTCHR CMPX    BUFEND   ;CHECK CURRENT LINE END AGAINST BUFFER END
       BNE    GETIT
