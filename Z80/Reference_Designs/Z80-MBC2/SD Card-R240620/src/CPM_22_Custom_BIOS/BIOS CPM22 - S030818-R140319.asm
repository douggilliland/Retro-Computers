;==============================================================================
;
; Z80-MBC2 (HW ref: A040618) CP/M 2.2 Custom BIOS - S030818-R140318
;
;
...
; S030818-R140318   Added CONST MODE to select 7 or 8 bit mode (for XMODEM)
;
;==============================================================================
...
BiosMsg     .db     cr, lf, lf, "Z80-MBC2 CP/M 2.2 BIOS - S030818-R140319", cr, lf, eos ;
