;==============================================================================
;
; Z80-MBC2 (HW ref: A040618) QP/M 2.71 Custom BIOS - S150918
;
;
; NOTE: This CBIOS requires IOS S220718-R100918 (or newer revisions until otherwise stated)
;
;
; CHANGELOG:
;
; S150918           First revision
;
;==============================================================================
...
BOOT_
    ...
    call    puts
    ;
    ; Set up the execution of AUTOEXEC.QSB if required
    ;
...
;                                                                             ;
; NOTE: If the RTC is not present, IOS will give all 0s bytes. This is        ;
;       "interpreted" by QP/M as a "NO CLOCK".                                ;
; =========================================================================== ;
TIMDAT
    jp      USERCLK
USERCLK
...
BiosMsg     .db     cr, lf, lf, "Z80-MBC2 QP/M 2.71 BIOS - S150918", cr, lf, eos
