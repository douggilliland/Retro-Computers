                    ...
                    (USBUART_1_EP[USBUART_1_midi_in_ep].bufferSize - USBUART_1_EVENT_LENGTH))
        {
            ...
            else /* Only SysEx message is greater than 4 bytes */
            {
                ...
                do
                {
                    ...
                    USBUART_1_PrepareInBuffer(USBUART_1_MIDI_SYSEX, &midiMsg[idx],
                                                     USBUART_1_EVENT_BYTE3, cable);

                    /* Move to next 3 bytes of message */
                    ic  -= USBUART_1_EVENT_BYTE3;
                    idx += USBUART_1_EVENT_BYTE3;
                ...
                if (retError == USBUART_1_FALSE)
                {
                    ...
                    USBUART_1_PrepareInBuffer(USBUART_1_MIDI_EOSEX, &midiMsg[idx], ic, cable);
                }
            }
        }
        else
    ...
    *******************************************************************************/
                                                                 ...
                                                                 
    {
        ...
        else if (ic == USBUART_1_MIDI_EOSEX)
        {
            ...
            {
                case 0u:
                    USBUART_1_midiInBuffer[USBUART_1_midiInPointer] = USBUART_1_SYSEX_ENDS_WITH1 | cable;
                    USBUART_1_midiInPointer++;
                    ...
                    break;
                case 1u:
                    USBUART_1_midiInBuffer[USBUART_1_midiInPointer] = USBUART_1_SYSEX_ENDS_WITH2 | cable;
                    USBUART_1_midiInPointer++;
                    USBUART_1_midiInBuffer[USBUART_1_midiInPointer] = srcBuffZero;
                    USBUART_1_midiInPointer++;
                    USBUART_1_midiInBuffer[USBUART_1_midiInPointer] = USBUART_1_MIDI_EOSEX;
                    ...
                    break;
                case 2u:
                    USBUART_1_midiInBuffer[USBUART_1_midiInPointer] = USBUART_1_SYSEX_ENDS_WITH3 | cable;
                    USBUART_1_midiInPointer++;
                    USBUART_1_midiInBuffer[USBUART_1_midiInPointer] = srcBuffZero;
                    USBUART_1_midiInPointer++;
                    USBUART_1_midiInBuffer[USBUART_1_midiInPointer] = srcBuffOne;
