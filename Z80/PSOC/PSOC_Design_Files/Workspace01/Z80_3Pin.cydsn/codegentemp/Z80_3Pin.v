...
module top ;
	...
	wire [0:0] tmpOE__CTS_n_net;
	wire [0:0] tmpIO_0__CTS_n_net;
	wire [0:0] tmpINTERRUPT_0__CTS_n_net;
	electrical [0:0] tmpSIOVREF__CTS_n_net;
	...
	cy_psoc3_pins_v1_10
		...
		CTS_n
		 (.oe(tmpOE__CTS_n_net),
		  .y({1'b0}),
		  .fb({Net_157}),
		  .io({tmpIO_0__CTS_n_net[0:0]}),
		  .siovref(tmpSIOVREF__CTS_n_net),
		  .interrupt({tmpINTERRUPT_0__CTS_n_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CTS_n_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RTS_n_net;
	wire [0:0] tmpFB_0__RTS_n_net;
	wire [0:0] tmpIO_0__RTS_n_net;
	wire [0:0] tmpINTERRUPT_0__RTS_n_net;
	electrical [0:0] tmpSIOVREF__RTS_n_net;
	...
	cy_psoc3_pins_v1_10
		...
		RTS_n
		 (.oe(tmpOE__RTS_n_net),
		  .y({Net_159}),
		  .fb({tmpFB_0__RTS_n_net[0:0]}),
		  .io({tmpIO_0__RTS_n_net[0:0]}),
		  .siovref(tmpSIOVREF__RTS_n_net),
		  .interrupt({tmpINTERRUPT_0__RTS_n_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RTS_n_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CyControlReg_v1_80 TOP_ADDR_REG (
        .control_1(LDA14),
        .control_2(LDA15),
        .control_3(LDA16),
        .control_0(LDA13),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam TOP_ADDR_REG.Bit0Mode = 0;
    defparam TOP_ADDR_REG.Bit1Mode = 0;
    defparam TOP_ADDR_REG.Bit2Mode = 0;
    defparam TOP_ADDR_REG.Bit3Mode = 0;
    defparam TOP_ADDR_REG.Bit4Mode = 0;
    defparam TOP_ADDR_REG.Bit5Mode = 0;
    defparam TOP_ADDR_REG.Bit6Mode = 0;
    defparam TOP_ADDR_REG.Bit7Mode = 0;
    defparam TOP_ADDR_REG.BitValue = 0;
    defparam TOP_ADDR_REG.BusDisplay = 0;
    defparam TOP_ADDR_REG.ExtrReset = 0;
    defparam TOP_ADDR_REG.NumOutputs = 8;

    // -- Mux start --
    if (1)
    begin : mux_5
        reg  tmp__mux_5_reg;
        always @(Net_234 or LDA18 or DRV_RAM)
        begin
            case (DRV_RAM)
                1'b0 :  tmp__mux_5_reg = Net_234;
                1'b1 :  tmp__mux_5_reg = LDA18;
            endcase
        end
    ...
    begin : mux_4
        reg  tmp__mux_4_reg;
        always @(Net_258 or LDA17 or DRV_RAM)
        begin
            case (DRV_RAM)
                1'b0 :  tmp__mux_4_reg = Net_258;
                1'b1 :  tmp__mux_4_reg = LDA17;
            endcase
        end
    ...
    begin : mux_3
        reg  tmp__mux_3_reg;
        always @(Net_226 or LDA16 or DRV_RAM)
        begin
            case (DRV_RAM)
                1'b0 :  tmp__mux_3_reg = Net_226;
                1'b1 :  tmp__mux_3_reg = LDA16;
            endcase
        end
    ...
    begin : mux_2
        reg  tmp__mux_2_reg;
        always @(Net_222 or LDA15 or DRV_RAM)
        begin
            case (DRV_RAM)
                1'b0 :  tmp__mux_2_reg = Net_222;
                1'b1 :  tmp__mux_2_reg = LDA15;
            endcase
        end
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_239 or LDA14 or DRV_RAM)
        begin
            case (DRV_RAM)
                1'b0 :  tmp__mux_1_reg = Net_239;
                1'b1 :  tmp__mux_1_reg = LDA14;
            endcase
        end
        assign Net_249 = tmp__mux_1_reg;
    end
    // -- Mux end --
    ...
    begin : mux_6
        reg  tmp__mux_6_reg;
        always @(Net_210 or LDA13 or DRV_RAM)
        begin
            case (DRV_RAM)
                1'b0 :  tmp__mux_6_reg = Net_210;
                1'b1 :  tmp__mux_6_reg = LDA13;
            endcase
        end
        assign Net_248 = tmp__mux_6_reg;
    end
    // -- Mux end --
	...
	assign tmpOE__CPUA11_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{DRV_RAM} : {DRV_RAM};

	wire [0:0] tmpOE__CPUA12_net;
	wire [0:0] tmpFB_0__CPUA12_net;
	...
	assign tmpOE__CPUA12_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{DRV_RAM} : {DRV_RAM};

    CyControlReg_v1_80 MID_ADDR_REG (
        .control_1(Net_281),
        .control_2(Net_284),
        .control_3(Net_287),
        .control_0(Net_278),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam MID_ADDR_REG.Bit0Mode = 0;
    defparam MID_ADDR_REG.Bit1Mode = 0;
    defparam MID_ADDR_REG.Bit2Mode = 0;
    defparam MID_ADDR_REG.Bit3Mode = 0;
    defparam MID_ADDR_REG.Bit4Mode = 0;
    defparam MID_ADDR_REG.Bit5Mode = 0;
    defparam MID_ADDR_REG.Bit6Mode = 0;
    defparam MID_ADDR_REG.Bit7Mode = 0;
    defparam MID_ADDR_REG.BitValue = 0;
    defparam MID_ADDR_REG.BusDisplay = 0;
    defparam MID_ADDR_REG.ExtrReset = 0;
    defparam MID_ADDR_REG.NumOutputs = 8;
    ...
    assign Net_386 = Net_343 | Net_337;


    assign Net_390 = Net_343 | Net_337 | CPURDn;


    assign Net_388 = Net_343 | Net_337 | CPUWRn;
    ...
    begin : mux_7
        reg  tmp__mux_7_reg;
        always @(Net_385 or Net_386 or DRV_RAM)
        begin
            case (DRV_RAM)
                1'b0 :  tmp__mux_7_reg = Net_385;
    ...
    begin : mux_8
        reg  tmp__mux_8_reg;
        always @(Net_366 or Net_388 or DRV_RAM)
        begin
            case (DRV_RAM)
                1'b0 :  tmp__mux_8_reg = Net_366;
