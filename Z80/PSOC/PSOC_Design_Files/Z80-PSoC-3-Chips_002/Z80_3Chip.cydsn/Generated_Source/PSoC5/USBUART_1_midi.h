...
#define USBUART_1_ENABLE_MIDI_API    (0u != (1u))
...
#define USBUART_1_ISR_SERVICE_MIDI_OUT \
            ((USBUART_1_ENABLE_MIDI_API != 0u) && (USBUART_1_MIDI_OUT_BUFF_SIZE > 0) && \
             (USBUART_1_EP_MANAGEMENT_DMA_AUTO))
...
/*******************************************************************************
* Function Name: USBUART_1_callbackLocalMidiEvent
****************************************************************************//**
*
...
#define USBUART_1_MIDI_EP_Init           USBUART_1_MIDI_Init
#define USBUART_1_MIDI_OUT_EP_Service    USBUART_1_MIDI_OUT_Service

#endif /* (CY_USBFS_USBUART_1_midi_H) */
