...
# Date: Sat, 02 Nov 2019 15:03:13 GMT
#set_units -time ns
create_clock -name {CPUCLK(routed)} -period 66.666666666666657 -waveform {0 33.3333333333333} [list [get_pins {ClockBlock/dclk_2}]]
...
create_generated_clock -name {CPUCLK} -source [get_pins {ClockBlock/clk_sync}] -edges {1 5 9} [list [get_pins {ClockBlock/dclk_glb_2}]]
