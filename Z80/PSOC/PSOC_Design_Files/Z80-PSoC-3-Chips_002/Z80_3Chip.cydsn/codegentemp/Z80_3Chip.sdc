...
# Date: Wed, 23 Oct 2019 01:29:49 GMT
#set_units -time ns
...
create_generated_clock -name {SPIM_1_IntClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 31 61} [list [get_pins {ClockBlock/dclk_glb_2}]]
