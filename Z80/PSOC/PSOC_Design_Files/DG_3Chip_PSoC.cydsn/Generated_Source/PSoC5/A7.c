...
{
    uint8 staticBits = (A7_DR & (uint8)(~A7_MASK));
    A7_DR = staticBits | ((uint8)(value << A7_SHIFT) & A7_MASK);
}
...
{
	CyPins_SetPinDriveMode(A7_0, mode);
}
...
{
    return (A7_DR & A7_MASK) >> A7_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(A7_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & A7_0_INTR) != 0u) 
		{ 
			 A7_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (A7_INTSTAT & A7_MASK) >> A7_SHIFT;
    }
