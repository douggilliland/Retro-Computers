...
module top ;
    ...
    CyControlReg_v1_80 BANK_REG (
        .control_1(BankAddr[13]),
        .control_2(BankAddr[14]),
        .control_3(BankAddr[15]),
        .control_0(Net_294),
        .control_4(BankAddr[16]),
        .control_5(BankAddr[17]),
        .control_6(BankAddr[18]),
        .control_7(Pass1Bank0),
        .clock(1'b0),
        .reset(1'b0));
    defparam BANK_REG.Bit0Mode = 0;
    defparam BANK_REG.Bit1Mode = 0;
    defparam BANK_REG.Bit2Mode = 0;
    defparam BANK_REG.Bit3Mode = 0;
    defparam BANK_REG.Bit4Mode = 0;
    defparam BANK_REG.Bit5Mode = 0;
    defparam BANK_REG.Bit6Mode = 0;
    defparam BANK_REG.Bit7Mode = 0;
    defparam BANK_REG.BitValue = 0;
    defparam BANK_REG.BusDisplay = 0;
    defparam BANK_REG.ExtrReset = 0;
    defparam BANK_REG.NumOutputs = 8;
    ...
    defparam MEM_CTRL.NumOutputs = 6;
