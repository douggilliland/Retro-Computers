...
*/
     ...
     *  @{
     */
        #define Pin_8_INTR_NONE      (uint16)(0x0000u)
        #define Pin_8_INTR_RISING    (uint16)(0x0001u)
        #define Pin_8_INTR_FALLING   (uint16)(0x0002u)
        #define Pin_8_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Pin_8_INTR_MASK      (0x01u) 
#endif /* (Pin_8__INTSTAT) */
...
/* SIO registers */
#if defined(Pin_8__SIO_CFG)
    #define Pin_8_SIO_HYST_EN        (* (reg8 *) Pin_8__SIO_HYST_EN)
    #define Pin_8_SIO_REG_HIFREQ     (* (reg8 *) Pin_8__SIO_REG_HIFREQ)
    #define Pin_8_SIO_CFG            (* (reg8 *) Pin_8__SIO_CFG)
    #define Pin_8_SIO_DIFF           (* (reg8 *) Pin_8__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define Pin_8_0_INTTYPE_REG 		(* (reg8 *) Pin_8__0__INTTYPE)
#endif /* (Pin_8__INTSTAT) */
