...
*
* \funcusage
*  \snippet Pin_10_SUT.c usage_Pin_10_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_10_SUT.c usage_Pin_10_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_10_SUT.c usage_Pin_10_Read  
*******************************************************************************/
...
* preferred Pin_10_Read() API because the 
* Pin_10_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Pin_10_SUT.c usage_Pin_10_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Pin_10_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Pin_10_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Pin_10_0_INTR       (First pin in the list)
    *  - Pin_10_1_INTR       (Second pin in the list)
    *  - ...
    *  - Pin_10_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Pin_10_SUT.c usage_Pin_10_SetInterruptMode
    *******************************************************************************/
    void Pin_10_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Pin_10_0_INTR) != 0u) 
		{ 
			 Pin_10_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Pin_10_SUT.c usage_Pin_10_ClearInterrupt
    *******************************************************************************/
