...
*
* \funcusage
*  \snippet Pin_20_SUT.c usage_Pin_20_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_20_SUT.c usage_Pin_20_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_20_SUT.c usage_Pin_20_Read  
*******************************************************************************/
...
* preferred Pin_20_Read() API because the 
* Pin_20_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Pin_20_SUT.c usage_Pin_20_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Pin_20_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Pin_20_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Pin_20_0_INTR       (First pin in the list)
    *  - Pin_20_1_INTR       (Second pin in the list)
    *  - ...
    *  - Pin_20_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Pin_20_SUT.c usage_Pin_20_SetInterruptMode
    *******************************************************************************/
    void Pin_20_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Pin_20_0_INTR) != 0u) 
		{ 
			 Pin_20_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Pin_20_SUT.c usage_Pin_20_ClearInterrupt
    *******************************************************************************/
