...
*/
     ...
     *  @{
     */
        #define Pin_14_INTR_NONE      (uint16)(0x0000u)
        #define Pin_14_INTR_RISING    (uint16)(0x0001u)
        #define Pin_14_INTR_FALLING   (uint16)(0x0002u)
        #define Pin_14_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Pin_14_INTR_MASK      (0x01u) 
#endif /* (Pin_14__INTSTAT) */
...
/* SIO registers */
#if defined(Pin_14__SIO_CFG)
    #define Pin_14_SIO_HYST_EN        (* (reg8 *) Pin_14__SIO_HYST_EN)
    #define Pin_14_SIO_REG_HIFREQ     (* (reg8 *) Pin_14__SIO_REG_HIFREQ)
    #define Pin_14_SIO_CFG            (* (reg8 *) Pin_14__SIO_CFG)
    #define Pin_14_SIO_DIFF           (* (reg8 *) Pin_14__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define Pin_14_0_INTTYPE_REG 		(* (reg8 *) Pin_14__0__INTTYPE)
#endif /* (Pin_14__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Pin_14_H */
