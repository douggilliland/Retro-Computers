...
/
/   NOTE: The settings used to build accompanying library file are listed
/   at the bottom of this file. If you wish to recompile the FatFs code
/   to incorporate further features, you may need to modify this file
/   to support a new configuration.
/
/   My modifications are released under the same agreement as that above. 
/   I accept no responsibility for the use of this component.
/
/----------------------------------------------------------------------------*/
...
extern void disk_timerproc(void);   //To be attached to an ISR (1 ms)
