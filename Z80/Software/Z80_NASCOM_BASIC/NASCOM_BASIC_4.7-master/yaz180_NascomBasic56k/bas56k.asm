...
WRKSPC  .EQU    2700H           ; <<<< BASIC Work space ** Rx buffer & Tx buffer located from 2700H **
...
BN      .EQU    28H             ; BIN error
        ...
        .ORG    0399H           ; <<<< Modified to allow for Z180 Tx/Rx interrupt

COLD:   JP      CSTART          ; Jump in for cold start (0399H)
