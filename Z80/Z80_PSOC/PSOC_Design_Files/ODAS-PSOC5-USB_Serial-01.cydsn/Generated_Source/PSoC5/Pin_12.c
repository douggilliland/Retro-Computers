...
*
* \funcusage
*  \snippet Pin_12_SUT.c usage_Pin_12_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_12_SUT.c usage_Pin_12_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_12_SUT.c usage_Pin_12_Read  
*******************************************************************************/
...
* preferred Pin_12_Read() API because the 
* Pin_12_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Pin_12_SUT.c usage_Pin_12_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Pin_12_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Pin_12_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Pin_12_0_INTR       (First pin in the list)
    *  - Pin_12_1_INTR       (Second pin in the list)
    *  - ...
    *  - Pin_12_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Pin_12_SUT.c usage_Pin_12_SetInterruptMode
    *******************************************************************************/
    void Pin_12_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Pin_12_0_INTR) != 0u) 
		{ 
			 Pin_12_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Pin_12_SUT.c usage_Pin_12_ClearInterrupt
    *******************************************************************************/
