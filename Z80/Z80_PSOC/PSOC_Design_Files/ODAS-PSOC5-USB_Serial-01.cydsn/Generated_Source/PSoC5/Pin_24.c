...
*
* \funcusage
*  \snippet Pin_24_SUT.c usage_Pin_24_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_24_SUT.c usage_Pin_24_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_24_SUT.c usage_Pin_24_Read  
*******************************************************************************/
...
* preferred Pin_24_Read() API because the 
* Pin_24_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Pin_24_SUT.c usage_Pin_24_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Pin_24_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Pin_24_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Pin_24_0_INTR       (First pin in the list)
    *  - Pin_24_1_INTR       (Second pin in the list)
    *  - ...
    *  - Pin_24_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Pin_24_SUT.c usage_Pin_24_SetInterruptMode
    *******************************************************************************/
    void Pin_24_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Pin_24_0_INTR) != 0u) 
		{ 
			 Pin_24_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Pin_24_SUT.c usage_Pin_24_ClearInterrupt
    *******************************************************************************/
