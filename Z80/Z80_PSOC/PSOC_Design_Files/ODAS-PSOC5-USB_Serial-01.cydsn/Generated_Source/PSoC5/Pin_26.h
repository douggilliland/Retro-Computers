...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Pin_26_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Pin_26__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Pin_26_SetInterruptMode() function.
     *  @{
     */
        #define Pin_26_INTR_NONE      (uint16)(0x0000u)
        #define Pin_26_INTR_RISING    (uint16)(0x0001u)
        #define Pin_26_INTR_FALLING   (uint16)(0x0002u)
        #define Pin_26_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Pin_26_INTR_MASK      (0x01u) 
#endif /* (Pin_26__INTSTAT) */
...
/* SIO registers */
#if defined(Pin_26__SIO_CFG)
    #define Pin_26_SIO_HYST_EN        (* (reg8 *) Pin_26__SIO_HYST_EN)
    #define Pin_26_SIO_REG_HIFREQ     (* (reg8 *) Pin_26__SIO_REG_HIFREQ)
    #define Pin_26_SIO_CFG            (* (reg8 *) Pin_26__SIO_CFG)
    #define Pin_26_SIO_DIFF           (* (reg8 *) Pin_26__SIO_DIFF)
#endif /* (Pin_26__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Pin_26_0_INTTYPE_REG 		(* (reg8 *) Pin_26__0__INTTYPE)
#endif /* (Pin_26__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Pin_26_H */
