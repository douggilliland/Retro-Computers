...
*/
     ...
     *  @{
     */
        #define Pin_24_INTR_NONE      (uint16)(0x0000u)
        #define Pin_24_INTR_RISING    (uint16)(0x0001u)
        #define Pin_24_INTR_FALLING   (uint16)(0x0002u)
        #define Pin_24_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Pin_24_INTR_MASK      (0x01u) 
#endif /* (Pin_24__INTSTAT) */
...
/* SIO registers */
#if defined(Pin_24__SIO_CFG)
    #define Pin_24_SIO_HYST_EN        (* (reg8 *) Pin_24__SIO_HYST_EN)
    #define Pin_24_SIO_REG_HIFREQ     (* (reg8 *) Pin_24__SIO_REG_HIFREQ)
    #define Pin_24_SIO_CFG            (* (reg8 *) Pin_24__SIO_CFG)
    #define Pin_24_SIO_DIFF           (* (reg8 *) Pin_24__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define Pin_24_0_INTTYPE_REG 		(* (reg8 *) Pin_24__0__INTTYPE)
#endif /* (Pin_24__INTSTAT) */
