...
*
* \funcusage
*  \snippet Pin_8_SUT.c usage_Pin_8_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_8_SUT.c usage_Pin_8_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_8_SUT.c usage_Pin_8_Read  
*******************************************************************************/
...
* preferred Pin_8_Read() API because the 
* Pin_8_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Pin_8_SUT.c usage_Pin_8_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Pin_8_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Pin_8_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Pin_8_0_INTR       (First pin in the list)
    *  - Pin_8_1_INTR       (Second pin in the list)
    *  - ...
    *  - Pin_8_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Pin_8_SUT.c usage_Pin_8_SetInterruptMode
    *******************************************************************************/
    void Pin_8_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Pin_8_0_INTR) != 0u) 
		{ 
			 Pin_8_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Pin_8_SUT.c usage_Pin_8_ClearInterrupt
    *******************************************************************************/
