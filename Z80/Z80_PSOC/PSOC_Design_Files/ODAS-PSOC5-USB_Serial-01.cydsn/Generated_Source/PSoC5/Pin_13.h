...
void    Pin_13_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Pin_13_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Pin_13__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Pin_13_SetInterruptMode() function.
     *  @{
     */
        #define Pin_13_INTR_NONE      (uint16)(0x0000u)
        #define Pin_13_INTR_RISING    (uint16)(0x0001u)
        #define Pin_13_INTR_FALLING   (uint16)(0x0002u)
        #define Pin_13_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Pin_13_INTR_MASK      (0x01u) 
#endif /* (Pin_13__INTSTAT) */
...
/* SIO registers */
#if defined(Pin_13__SIO_CFG)
    #define Pin_13_SIO_HYST_EN        (* (reg8 *) Pin_13__SIO_HYST_EN)
    #define Pin_13_SIO_REG_HIFREQ     (* (reg8 *) Pin_13__SIO_REG_HIFREQ)
    #define Pin_13_SIO_CFG            (* (reg8 *) Pin_13__SIO_CFG)
    #define Pin_13_SIO_DIFF           (* (reg8 *) Pin_13__SIO_DIFF)
#endif /* (Pin_13__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Pin_13_0_INTTYPE_REG 		(* (reg8 *) Pin_13__0__INTTYPE)
#endif /* (Pin_13__INTSTAT) */
