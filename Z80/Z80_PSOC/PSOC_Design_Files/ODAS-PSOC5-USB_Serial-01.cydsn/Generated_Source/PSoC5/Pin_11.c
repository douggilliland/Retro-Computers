...
*
* \funcusage
*  \snippet Pin_11_SUT.c usage_Pin_11_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_11_SUT.c usage_Pin_11_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_11_SUT.c usage_Pin_11_Read  
*******************************************************************************/
...
* preferred Pin_11_Read() API because the 
* Pin_11_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Pin_11_SUT.c usage_Pin_11_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Pin_11_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Pin_11_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Pin_11_0_INTR       (First pin in the list)
    *  - Pin_11_1_INTR       (Second pin in the list)
    *  - ...
    *  - Pin_11_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Pin_11_SUT.c usage_Pin_11_SetInterruptMode
    *******************************************************************************/
    void Pin_11_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Pin_11_0_INTR) != 0u) 
		{ 
			 Pin_11_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Pin_11_SUT.c usage_Pin_11_ClearInterrupt
    *******************************************************************************/
