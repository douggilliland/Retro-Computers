...
{
    uint8 staticBits = (Pin_28_DR & (uint8)(~Pin_28_MASK));
    Pin_28_DR = staticBits | ((uint8)(value << Pin_28_SHIFT) & Pin_28_MASK);
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Pin_28_0_INTR) != 0u) 
		{ 
			 Pin_28_0_INTTYPE_REG = (uint8)mode; 
		}
    }
