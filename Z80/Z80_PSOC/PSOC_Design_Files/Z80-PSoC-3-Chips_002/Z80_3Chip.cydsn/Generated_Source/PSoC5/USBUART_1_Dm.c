...
*
* \funcusage
*  \snippet USBUART_1_Dm_SUT.c usage_USBUART_1_Dm_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet USBUART_1_Dm_SUT.c usage_USBUART_1_Dm_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet USBUART_1_Dm_SUT.c usage_USBUART_1_Dm_Read  
*******************************************************************************/
...
* preferred USBUART_1_Dm_Read() API because the 
* USBUART_1_Dm_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet USBUART_1_Dm_SUT.c usage_USBUART_1_Dm_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: USBUART_1_Dm_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use USBUART_1_Dm_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - USBUART_1_Dm_0_INTR       (First pin in the list)
    *  - USBUART_1_Dm_1_INTR       (Second pin in the list)
    *  - ...
    *  - USBUART_1_Dm_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet USBUART_1_Dm_SUT.c usage_USBUART_1_Dm_SetInterruptMode
    *******************************************************************************/
    void USBUART_1_Dm_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & USBUART_1_Dm_0_INTR) != 0u) 
		{ 
			 USBUART_1_Dm_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet USBUART_1_Dm_SUT.c usage_USBUART_1_Dm_ClearInterrupt
    *******************************************************************************/
