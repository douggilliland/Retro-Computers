/*******************************************************************************
* File Name: NSDSPI_1_UDB_BIT_COUNTER.c
* Version 1.0
*
* Description:
...
uint8 NSDSPI_1_UDB_BIT_COUNTER_initVar = 0u;


/*******************************************************************************
* Function Name: NSDSPI_1_UDB_BIT_COUNTER_Init
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void NSDSPI_1_UDB_BIT_COUNTER_Init(void) 
{
    /* Set the initial period value from parameter editor */
    NSDSPI_1_UDB_BIT_COUNTER_PERIOD_REG = NSDSPI_1_UDB_BIT_COUNTER_INITIAL_PERIOD;
}


/*******************************************************************************
* Function Name: NSDSPI_1_UDB_BIT_COUNTER_Enable
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void NSDSPI_1_UDB_BIT_COUNTER_Enable(void) 
{
    ...
    */
    NSDSPI_1_UDB_BIT_COUNTER_AUX_CONTROL_REG |= NSDSPI_1_UDB_BIT_COUNTER_COUNTER_START;
...
/*******************************************************************************
* Function Name: NSDSPI_1_UDB_BIT_COUNTER_Start
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  NSDSPI_1_UDB_BIT_COUNTER_initVar - global variable.
*
* Return:
*  None.
*
*******************************************************************************/
void NSDSPI_1_UDB_BIT_COUNTER_Start(void) 
{
    /* If not initialized then perform initialization */
    if(NSDSPI_1_UDB_BIT_COUNTER_initVar == 0u)
    {
        NSDSPI_1_UDB_BIT_COUNTER_Init();
        NSDSPI_1_UDB_BIT_COUNTER_initVar = 1u;
    }
...
/*******************************************************************************
* Function Name: NSDSPI_1_UDB_BIT_COUNTER_Stop
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void NSDSPI_1_UDB_BIT_COUNTER_Stop(void) 
{
    uint8 interruptState;

    interruptState = CyEnterCriticalSection();
    /* Clear the counter start bit in auxiliary control. */
    NSDSPI_1_UDB_BIT_COUNTER_AUX_CONTROL_REG &= (uint8) ~((uint8) NSDSPI_1_UDB_BIT_COUNTER_COUNTER_START);
...
/*******************************************************************************
* Function Name: NSDSPI_1_UDB_BIT_COUNTER_WriteCounter
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void NSDSPI_1_UDB_BIT_COUNTER_WriteCounter(uint8 count) 
{
    NSDSPI_1_UDB_BIT_COUNTER_COUNT_REG = (count & NSDSPI_1_UDB_BIT_COUNTER_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: NSDSPI_1_UDB_BIT_COUNTER_ReadCounter
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 NSDSPI_1_UDB_BIT_COUNTER_ReadCounter(void) 
{
    return(NSDSPI_1_UDB_BIT_COUNTER_COUNT_REG & NSDSPI_1_UDB_BIT_COUNTER_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: NSDSPI_1_UDB_BIT_COUNTER_WritePeriod
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void NSDSPI_1_UDB_BIT_COUNTER_WritePeriod(uint8 period) 
{
    NSDSPI_1_UDB_BIT_COUNTER_PERIOD_REG = period;
}


/*******************************************************************************
* Function Name: NSDSPI_1_UDB_BIT_COUNTER_ReadPeriod
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 NSDSPI_1_UDB_BIT_COUNTER_ReadPeriod(void) 
{
    return(NSDSPI_1_UDB_BIT_COUNTER_PERIOD_REG);
}
