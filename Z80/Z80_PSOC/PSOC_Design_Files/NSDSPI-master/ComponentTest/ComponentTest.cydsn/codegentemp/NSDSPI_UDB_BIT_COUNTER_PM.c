/*******************************************************************************
* File Name: NSDSPI_UDB_BIT_COUNTER_PM.c
* Version 1.0
*
* Description:
...
NSDSPI_UDB_BIT_COUNTER_BACKUP_STRUCT NSDSPI_UDB_BIT_COUNTER_backup;


/*******************************************************************************
* Function Name: NSDSPI_UDB_BIT_COUNTER_SaveConfig
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  NSDSPI_UDB_BIT_COUNTER_backup - used to save component configuration and non-
*  retention registers before enter sleep mode.
*
*******************************************************************************/
void NSDSPI_UDB_BIT_COUNTER_SaveConfig(void) 
{
    NSDSPI_UDB_BIT_COUNTER_backup.count = NSDSPI_UDB_BIT_COUNTER_COUNT_REG;
}


/*******************************************************************************
* Function Name: NSDSPI_UDB_BIT_COUNTER_Sleep
********************************************************************************
*
* Summary:
...
{
    if(0u != (NSDSPI_UDB_BIT_COUNTER_AUX_CONTROL_REG & NSDSPI_UDB_BIT_COUNTER_COUNTER_START))
    {
        NSDSPI_UDB_BIT_COUNTER_backup.enableState = 1u;
        NSDSPI_UDB_BIT_COUNTER_Stop();
    }
    else
    {
        NSDSPI_UDB_BIT_COUNTER_backup.enableState = 0u;
    }

    NSDSPI_UDB_BIT_COUNTER_SaveConfig();
}


/*******************************************************************************
* Function Name: NSDSPI_UDB_BIT_COUNTER_RestoreConfig
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  NSDSPI_UDB_BIT_COUNTER_backup - used to save component configuration and
*  non-retention registers before exit sleep mode.
*
*******************************************************************************/
void NSDSPI_UDB_BIT_COUNTER_RestoreConfig(void) 
{
    NSDSPI_UDB_BIT_COUNTER_COUNT_REG = NSDSPI_UDB_BIT_COUNTER_backup.count;
}


/*******************************************************************************
* Function Name: NSDSPI_UDB_BIT_COUNTER_Wakeup
********************************************************************************
*
* Summary:
...
{
    NSDSPI_UDB_BIT_COUNTER_RestoreConfig();

    /* Restore enable state */
    if (NSDSPI_UDB_BIT_COUNTER_backup.enableState != 0u)
    {
