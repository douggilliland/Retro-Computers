...
*
* \funcusage
*  \snippet LED5_4_SUT.c usage_LED5_4_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet LED5_4_SUT.c usage_LED5_4_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet LED5_4_SUT.c usage_LED5_4_Read  
*******************************************************************************/
...
* preferred LED5_4_Read() API because the 
* LED5_4_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet LED5_4_SUT.c usage_LED5_4_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: LED5_4_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use LED5_4_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - LED5_4_0_INTR       (First pin in the list)
    *  - LED5_4_1_INTR       (Second pin in the list)
    *  - ...
    *  - LED5_4_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet LED5_4_SUT.c usage_LED5_4_SetInterruptMode
    *******************************************************************************/
    void LED5_4_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & LED5_4_0_INTR) != 0u) 
		{ 
			 LED5_4_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet LED5_4_SUT.c usage_LED5_4_ClearInterrupt
    *******************************************************************************/
