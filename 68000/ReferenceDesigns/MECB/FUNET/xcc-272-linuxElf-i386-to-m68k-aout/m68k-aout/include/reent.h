...
/* The reentrant system calls here serve two purposes:
   ...
   1) Define the reentrant versions of the syscalls directly.
      ...
      You should also provide the regular versions of these (eg: open, close).
      When you do this, add -DREENTRANT_SYSCALLS_PROVIDED to target_cflags
      in configure.in.
   ...
   2) Define namespace clean versions of the system calls by prefixing
      ...
      clean.
      When you do this, set "fake_sys_dir" to "syscalls" in configure.in.
