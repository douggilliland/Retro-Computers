...
set project_name chameleon2_life
set project_path chameleon2_life_files
set ownpath ..
set rtlpath ../../../../rtl
...
# Toplevel entities
set_global_assignment -name VHDL_FILE $ownpath/chameleon2_life.vhd
set_global_assignment -name SDC_FILE $ownpath/chameleon2_life.sdc
