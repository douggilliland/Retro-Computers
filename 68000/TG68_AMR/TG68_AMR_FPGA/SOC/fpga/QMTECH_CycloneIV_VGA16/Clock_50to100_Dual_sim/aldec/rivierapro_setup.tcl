...
# ACDS 20.1 711 win32 2020.09.05.08:50:56
# ----------------------------------------
...
# ----------------------------------------
# If Clock_50to100_Dual is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "Clock_50to100_Dual"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/Clock_50to100_Dual.vho"
}
